...
data_path = '/mnt/bn/zhufangqi-lq-c2ec0f30/zhufangqi/world-model/data_preprocessing/data/rt1_100'
...
model = dict(
    type="STDiT3-XL/2",
    from_pretrained="outputs/006-STDiT3-XL-2/epoch5-global_step80000/ema.safetensors",
    qk_norm=True,
