...
data_path = '/mnt/hdfs/zhufangqi/logs/cleandiffuser/libero/0214/aug_random=True_depth=1_width=1'
...
model = dict(
    type="STDiT3-XL/2",
    from_pretrained="/mnt/hdfs/zhufangqi/checkpoints/opensora/libero/02/20/2_8/000-STDiT3-XL-2/epoch0-global_step10000/ema.pt",
    qk_norm=True,
