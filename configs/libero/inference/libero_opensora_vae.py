...
model = dict(
    type="STDiT3-XL/2",
    from_pretrained="/mnt/hdfs/zhufangqi/checkpoints/opensora/libero/06/12/opensora_vae/000-STDiT3-XL-2/epoch9-global_step2500/ema.pt",
    qk_norm=True,
...
vae = dict(
    ...
    from_pretrained="/mnt/hdfs/zhufangqi/pretrained_models/hpcai-tech/OpenSora-VAE-v1.2/model.safetensors",
    micro_frame_size=20,
    micro_batch_size=4,
)
# vae = dict(
