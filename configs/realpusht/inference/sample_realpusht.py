...
data_path = '/opt/tiger/opensora/data/0409.h5'
...
model = dict(
    type="STDiT3-XL/2",
    from_pretrained="/mnt/hdfs/zhufangqi/checkpoints/opensora/realpusht/04/09/8H100/000-STDiT3-XL-2/epoch208-global_step50000",
    qk_norm=True,
...
vae = dict(
    type="SDXL",
    from_pretrained="/mnt/hdfs/zhufangqi/datasets/realpusht/vae_ckpt/output_96_72/epoch_5",
    micro_frame_size=8,
    micro_batch_size=64,
)
text_encoder = dict(
