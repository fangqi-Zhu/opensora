...
model = dict(
    type="STDiT3-XL/2",
    from_pretrained="/mnt/hdfs/lab_robot_research/pretrained_models/hpcai-tech/OpenSora-STDiT-v3/model.safetensors",
    qk_norm=True,
...
vae = dict(
    type="SDXL",
    from_pretrained="/mnt/hdfs/lab_robot_research/pretrained_models/stabilityai/stable-diffusion-xl-base-1.0/vae",
    micro_frame_size=8,
    micro_batch_size=64,
)
# text_encoder = dict(
...
# Log settings
seed = 42
outputs = "/mnt/hdfs/lab_robot_research/checkpoints/opensora/libero/debug"
wandb = True
epochs = 1000
log_every = 10
ckpt_every = 100
