...
class MaskGenerator:
    ...
    def get_mask(self, x):
        ...
        if mask_name == "quarter_random":
            ...
            random_size = 1
            mask[-random_size:] = 0
        elif mask_name == "video_obs_2_frame":
            mask[0:2] = 0
        elif mask_name == "video_obs_4_frame":
            mask[0:4] = 0
        elif mask_name == "video_obs_4_frame":
            mask[0:1] = 0
        elif mask_name == "video_half_tail":
            random_size = int(num_frames / 2)
            mask[0:-random_size] = 0
        elif mask_name == "video_tail":
            random_size = 1
            mask[0:-random_size] = 0
