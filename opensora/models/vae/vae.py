...
def OpenSoraVAE_V1_2(
    ...
    # vae_2d_path = '/mnt/hdfs/lab_robot_research/pretrained_models/PixArt-alpha/pixart_sigma_sdxlvae_T5_diffusers'

    vae_2d = dict(
        type="VideoAutoencoderKL",
        from_pretrained="/mnt/hdfs/zhufangqi/pretrained_models/PixArt-alpha/pixart_sigma_sdxlvae_T5_diffusers",
        subfolder="vae",
...
def SDXL(
    ...
    #     config = VideoAutoencoderPipelineConfig(**kwargs)
    #     model = VideoAutoencoderPipeline(config)
    model = VideoAutoencoderKL(**kwargs)
